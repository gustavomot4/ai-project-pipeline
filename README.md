...
**A limitação honesta mais importante:** o kit tem **188** itens de checklist (69 no [[b_checklist|CHECKLIST]] + 104 nos `b_process/skills/`); `scripts/check.py` julga **18** deles (12 reprovam o commit, 6 avisam) — cerca de 10%. O resto depende de você rodar a seção certa do [[b_checklist|CHECKLIST]]. Isto é um kit de disciplina com algumas travas automáticas — não um sistema que impede erro.
