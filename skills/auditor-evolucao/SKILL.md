...
`CONTEXT.md` + `DECISIONS.md` **inteiro** — é a memória do que já falhou. Esta é a única fase que carrega o DECISIONS completo; por isso o teto de 2 frases por linha existe.
...
6. **Rejeição é entrega:** D-NN REJEITADO com o motivo ou número que matou (evidência longa → `dev/<slug>.md`).
