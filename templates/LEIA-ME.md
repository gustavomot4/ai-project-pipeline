...
|---|---|---|
| [[templates/decisao\|decisao]] | tabela "Decisões" do [[DECISIONS]] | assunto fechado — inclusive quando a decisão é **rejeitar** |
| [[templates/achado-qa\|achado-qa]] | tabela "Achados de QA" do [[DECISIONS]] | cada achado de uma sessão de [[skills/guardrails-review/SKILL\|guardrails-review]] |
| [[templates/fecho-de-sessao\|fecho-de-sessao]] | nota de rascunho, ou direto na conversa com o agente | **toda** vez que uma sessão termina |
...
O ciclo de fechamento (D-NN → CONTEXT por substituição → CHANGELOG datado → commit citando IDs) está descrito em prosa no [[README]], no [[ROTEIRO]], no [[CONTEXT]] e no [[CHECKLIST]] — quatro lugares, nenhum acionável no momento em que você precisa dele. Pular um passo é o que faz o estado divergir (regra 6) e o histórico sumir (regra 2). Como lista marcável, o passo esquecido fica visível.
